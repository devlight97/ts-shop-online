                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-12">
                      <div className="form-group">
                        ...
                        <input type="number" name="number" placeholder="placeholder" required />
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-12">
                      <div className="form-group">
                    ...
                    <div className="col-lg-6 col-md-6 col-12">
                      <div className="form-group">
                        ...
                        <select name="state-province" id="state-province">
                          <option value="divition" selected>
                            New Yourk
                          </option>
                    ...
                    <div className="col-lg-6 col-md-6 col-12">
                      <div className="form-group">
                        ...
                        <input type="text" name="address" placeholder="placeholder" required />
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-12">
                      <div className="form-group">
                    ...
                    <div className="col-lg-6 col-md-6 col-12">
                      <div className="form-group">
                        ...
                        <input type="text" name="post" placeholder="placeholder" required />
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-12">
                      <div className="form-group">
